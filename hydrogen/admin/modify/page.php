...
<a href=\"deleted_page.php?file=".$row['category']."\" onclick=\"return confirm('Wait!!! Are you sure you want to delete this ".$row['category'].".  This action cannot be undone!!');\" title=\"Delete ".$row['category'].". This action cannot be undone!!\" style=\"float:right;\">delete page</a></li>";  
  }
echo"</ul>";
?>