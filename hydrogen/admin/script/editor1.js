...
function WYSIWYG_Editor(instance_name, content, path, fwidth, fheight, styleHref, spellCheckPath){
    ...
    this.font_format_toolbar1_after = true;
    ...
    this.web_toolbar3_after = true;
    this.web_toolbar4_after = true;
    this.misc_format_toolbar_after = true;
...
WYSIWYG_Editor.prototype.insertImage = function (){
    this.imagePopUp=window.open(this.site_path+'/repositoryfull1.php?page_title='+this.page_title,'','width=620,height=500,resizable=1,scrollbars=yes');
