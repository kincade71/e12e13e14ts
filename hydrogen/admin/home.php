...
<div id="headerwrapper">  <div class="header" style="float:right;">Welcome: <?php echo $_SESSION['last']; ?> | <a href="logout.php" title="Logout: <?php echo $_SESSION['name']; ?>  <?php echo $_SESSION['last']; ?>">Logout</a>
