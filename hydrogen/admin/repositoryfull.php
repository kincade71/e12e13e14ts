...
while($row = mysql_fetch_array($result))
  {
  echo"<li><a href=\"javascript:;\" onClick=\"opener.editor1.addImage('".$CFG->wwwroot.$row['image']."')\">
  <img src=\"".$CFG->wwwroot.$row['image']."\" height=\"50\"/><img src=\"".$CFG->wwwroot.$row['image']."\" height=\"50\"class=\"preview\"/></a></li>";
  }
?>
    </ul>    
  </div>
